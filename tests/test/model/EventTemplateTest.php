...
class EventTemplateTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testsetId()
    {
        ...
        $this->assertEquals(
                            123456789, 
                            PHPUnit_Framework_TestCase::readAttribute($eventtemplate, "id")
                            );
    }
    ...
    public function testsetStart_time()
    {
        ...
        $this->assertEquals(
                            123456789, 
                            PHPUnit_Framework_TestCase::readAttribute($eventtemplate, "start_time")
                            );
    }
   ...
   public function testsetEnd_time()
    {
        ...
        $this->assertEquals(
                            123456789, 
                            PHPUnit_Framework_TestCase::readAttribute($eventtemplate, "end_time")
                            );
    }
    ...
    public function testsetEvents()
    {
        ...
        $this->assertEquals(
                            "template123", 
                            PHPUnit_Framework_TestCase::readAttribute($eventtemplate, "events")
                            );
    }
